...
%w0_wind = abs(sqrt(0.9583)); % TODO, change this
%epsilon = 0.06269/(2*w0_wind); % TODO, change this
w0_wind = abs(sqrt(0.9555)); % TODO, change this
epsilon = 0.06502/(2*w0_wind); % TODO, change this
