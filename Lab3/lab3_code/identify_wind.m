...
disp('done sim')
%% From wind
%R = 0.695;%TODO might be needed to change
R = 10.44;
%R = 5.3;
...
opts = armaxOptions;
%armax2 = armax(dat,[2 2 2 1]) %TODO select suitable model structre
%na = 2;
na = 2;
nb = 2;
%nc = 2;
nc = 1;
nk = 1;
armax2 = armax(dat,[na nc]) %compare armax with wind.denum
figure(1)
clf
